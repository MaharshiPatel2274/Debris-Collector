...
minutes_to_track = 90  # Track for 90 minutes
time_range = ts.utc(2025, 3, 29, 0, range(0, minutes_to_track))

# Simulated satellite from Kennedy Space Center
...
# Get simulated satellite positions
...
ax.set_ylabel('Y (km)')
ax.set_zlabel('Z (km)')
ax.set_title("3D Orbital Simulation with Satellite & Debris Paths")
ax.legend()
plt.tight_layout()
plt.show()
